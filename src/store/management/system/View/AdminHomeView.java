...
public class AdminHomeView extends JFrame{
    CustomMenuButton homeButton, staffButton, invoiceButton, productButton,reportButton;
    ...
    public AdminHomeView(){
        ...
        productButton.setBounds(7, 175, 180, 45);
    ...
    public void addProductMenuButtonListner(ActionListener addProductMenuButtonListner){
        productButton.addActionListener(addProductMenuButtonListner);
    }
