...
public class AdminStaffView extends CustomPanel {
    ...
    CustomButton searchButton, addStaffButton, updateStaffButton, deleteStaffButton;
    ...
    public AdminStaffView(AdminHomeView adminHomeView) {
        ...
        */
        ...
        // Update Staff Button
        updateStaffButton = new CustomButton();
        updateStaffButton.setText("Update Staff");
        updateStaffButton.setFocusable(false);
        updateStaffButton.setCursor(new Cursor(Cursor.HAND_CURSOR));
        updateStaffButton.setFont(new Font("Arial", Font.BOLD, 18));
        updateStaffButton.setForeground(Color.black);
        updateStaffButton.setBackground(new Color(217, 74, 70));
        updateStaffButton.setHoverColor(new Color(197, 54, 50));
        updateStaffButton.setPressColor(new Color(177, 34, 30));
        updateStaffButton.setBounds(200, 550, 130, 50);
        super.add(updateStaffButton);
        
        // Delete Staff Button
        deleteStaffButton = new CustomButton();
        deleteStaffButton.setText("Delete Staff");
        deleteStaffButton.setFocusable(false);
        deleteStaffButton.setCursor(new Cursor(Cursor.HAND_CURSOR));
        deleteStaffButton.setFont(new Font("Arial", Font.BOLD, 18));
        deleteStaffButton.setForeground(Color.black);
        deleteStaffButton.setBackground(new Color(217, 74, 70));
        deleteStaffButton.setHoverColor(new Color(197, 54, 50));
        deleteStaffButton.setPressColor(new Color(177, 34, 30));
        deleteStaffButton.setBounds(390, 550, 130, 50);
        super.add(deleteStaffButton);
...
class UpdateStaffPanel extends CustomPanel {
    ...
    public UpdateStaffPanel() {
        ...
        updateButton.setBounds(1025, 165, 120, 47);
